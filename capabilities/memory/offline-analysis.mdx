...
description: "Notebook-style analysis of recorded memory2 data: plotting, semantic search, mosaics"
---

This page is offline analysis of **recorded** data with the memory2 plotting and search APIs. It is not live robot memory - for that, see [Memory](/capabilities/memory).
