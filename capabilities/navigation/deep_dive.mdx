...
For return visits to a known space, use [premap relocalization](/capabilities/navigation/relocalization) instead of relying on live mapping alone.
...
![Go2 navigation data flow](/capabilities/navigation/assets/go2nav_dataflow.svg)
...
![LiDAR frame](/capabilities/navigation/assets/1-lidar.png)
...
Live column-carving has no loop closure. We trust Go2 odometry, which is stable but drifts over distance. You can reliably map and navigate large spaces around 500 m² in our tests, but not kilometer-scale outdoor routes. For return visits with loop-closed maps, use [premap relocalization](/capabilities/navigation/relocalization) and build the premap offline with `dimos map global --export`.
...
![Global map](/capabilities/navigation/assets/2-globalmap.png)
...
![Global costmap](/capabilities/navigation/assets/3-globalcostmap.png)
...
![Navigation costmap with path](/capabilities/navigation/assets/4-navcostmap.png)

### 5. All Layers Combined

All visualization layers shown together:

![All layers](/capabilities/navigation/assets/5-all.png)
...
|----------|----------|--------|
| ![coverage](/capabilities/navigation/assets/coverage.png) | ![frontier](/capabilities/navigation/assets/frontier.png) | ![random](/capabilities/navigation/assets/random.png) |

### Sample patrol trace (26 min)

![Patrol path](/capabilities/navigation/assets/patrol_path.png)
...
```
![unitree_go2 blueprint module graph](/capabilities/navigation/assets/go2_blueprint.svg)
