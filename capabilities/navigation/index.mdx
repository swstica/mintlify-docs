...
|----------|-------------|-----------|------|
| **Live mapping** | Explore a new space where the map updates every frame | `unitree-go2` | [Navigation deep dive](/capabilities/navigation/deep_dive) |
...
For hardware setup, simulation, and the full blueprint list, see the [Go2 platform guide](/platforms/quadruped/go2/index).
