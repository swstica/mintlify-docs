...
Recordings are stored in the `data/` directory. See [Data Loading](/development/large_file_management) for how data storage works, including Git LFS handling for large datasets.
