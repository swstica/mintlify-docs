...
![output](/usage/data_streams/assets/alignment_overview.svg)
...
You can read more about [sensor storage here](/usage/data_streams/storage_replay) and [LFS data storage here](/development/large_file_management).
...
![output](/usage/data_streams/assets/alignment_timeline.png)
...
![output](/usage/data_streams/assets/alignment_timeline2.png)

## Combine Frame Alignment with a Quality Filter

More on [quality filtering here](/usage/data_streams/quality_filter).
...
![output](/usage/data_streams/assets/alignment_timeline3.png)
...
![output](/usage/data_streams/assets/alignment_flow.svg)
