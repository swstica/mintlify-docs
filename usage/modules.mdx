...
```
![output](/usage/assets/go2_nav.svg)
...
It also exposes an agentic [skill](/usage/blueprints#defining-skills) called `take_a_picture` (more on skills in the Blueprints guide).
...
![output](/usage/assets/go2_agentic.svg)

To see more information on how to use Blueprints, see [Blueprints](/usage/blueprints).
