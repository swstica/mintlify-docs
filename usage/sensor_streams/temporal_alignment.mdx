...
![output](/usage/sensor_streams/assets/alignment_overview.svg)
...
You can read more about [sensor storage here](/usage/sensor_streams/storage_replay) and [LFS data storage here](/development/large_file_management).
...
![output](/usage/sensor_streams/assets/alignment_timeline.png)
...
![output](/usage/sensor_streams/assets/alignment_timeline2.png)

## Combine Frame Alignment with a Quality Filter

More on [quality filtering here](/usage/sensor_streams/quality_filter).
...
![output](/usage/sensor_streams/assets/alignment_timeline3.png)
...
![output](/usage/sensor_streams/assets/alignment_flow.svg)
