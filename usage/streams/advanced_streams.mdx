...
> **Prerequisite:** Read [ReactiveX Fundamentals](/usage/streams/reactivex) first for Observable basics.
...
![output](/usage/streams/assets/backpressure.svg)
...
![output](/usage/streams/assets/backpressure_solution.svg)
...
If you are doing this periodically as a part of a processing loop, it is very likely that your code will be much cleaner and safer using actual reactivex pipeline. So bias towards checking our [reactivex quick guide](/usage/streams/reactivex) and [official docs](https://rxpy.readthedocs.io)
...
![output](/usage/streams/assets/getter_hot_cold.svg)
